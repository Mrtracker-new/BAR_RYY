...
const T = {
  ...
  goldBorder:  'rgba(180,121,30,0.20)',
      ...
      <div>
        ...
        <div
          style={{
            ...
            background: 'rgba(250,244,230,0.80)',
            backdropFilter: 'blur(12px)',
            WebkitBackdropFilter: 'blur(12px)',
            boxShadow: '0 16px 48px rgba(60,45,20,0.12)',
          }}
        >
          {/* ── Header ── */}
          ...
          {error && (
            ...
            >
              ...
              <p style={{ fontSize: '0.875rem', color: '#8A2B22', lineHeight: 1.6, margin: 0 }}>
                {error}
              </p>
            </div>
          )}
          ...
          <div style={{ marginBottom: '1.25rem' }}>
            ...
            <button
              ...
              style={{
                ...
                background: barFile ? T.goldDim : 'rgba(60,45,20,0.04)',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.625rem' }}>
                ...
                <div
                  style={{
                    ...
                    paddingTop: '0.625rem', borderTop: `1px solid rgba(60,45,20,0.08)`,
                    marginTop: '0.25rem',
                  }}
                >
                  ...
                  <span
                    style={{
                      ...
                      ...(metadata.password_protected
                        ...
                        : { background: 'rgba(63,125,58,0.08)', color: '#3F7D3A', border: '1px solid rgba(63,125,58,0.18)' }
                      ),
                    }}
                  >
          ...
          {metadata?.storage_mode === 'server' ? (
            ...
            >
              <p style={{ fontSize: '0.875rem', color: 'rgba(180,121,30,0.85)' }}>
...
function MetaRow({ label, value }) {
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem' }}>
      <span
        style={{
          fontSize: '0.8125rem', color: '#857358',
          flexShrink: 0,
        }}
      >
        {label}
